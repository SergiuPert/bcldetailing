...
const About = () => {
    return (
            <div className="AboutContentDiv">
                ...
                <p>Sloganul care ne reprezinta si dupa care ne ghidam ‘’Din pasiune pentru masini’, expune punctul de pornire si motivatia dezvoltarii activitatii noastre. Viziunea noastra este de a deveni un jucator relevant pe piata de detailing auto.</p>
